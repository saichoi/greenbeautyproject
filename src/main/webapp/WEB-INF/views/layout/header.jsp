...
<body style="max-width: 80%; height: auto; margin: 0 auto;">
	...
	<header>
		<!-- 네브바 시작 -->
		<nav
			class="header navbar navbar-expand-lg navbar-light bg-light d-flex">

			<!-- 왼쪽 메뉴 -->

			<div class="left-nav d-flex flex-row p2">
				<div class="logo p-2">
					<a class="navbar-brand" href="/test/board"> 화장품을 분석하다 </a>
				</div>

				<div class="collapse navbar-collapse p-2" id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item active"><a class="nav-link"
							href="/test/board">리뷰보기</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/test/item/list">제품보기</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="right-nav ml-auto p-2">
				<ul class="navbar-nav">
					<li class="nav-item mr-3"><a class="nav-link"
						href="/test/user/mypage"> <i class="bi bi-heart-fill"></i>
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/test/user/mypage"> <i class="bi bi-person-fill"></i>
					</a></li>
		...
		<div class="ham-con">
			...
			<div class="navbar-nav">
				<div class="search-con d-flex justify-content-center">
					<input type="text" placeholder="검색어를 입력해주세요." /> <i
			...
			<div id="ham-menu-wrap">
				...
				<div class="ham-menu">
					<div class="ham-top-menu">
						<div class="ham-clicktoggle">
							리뷰보기<i class="bi bi-caret-down-fill"></i>
						</div>
				...
				<div class="ham-menu">
					<div class="ham-top-menu">
						<div class="ham-clicktoggle">
							제품보기<i class="bi bi-caret-down-fill"></i>
						</div>
						<ul class="ham-sub-menu">
